...
public class BancoDeDados {
	...
	//criando metodo de inseção de registro
// fazendo a validaçaõ dos comandos com try/cathc
...
try {
	...
	public void editarContatos(String nome, String id) {

		try {
			String query = "update contato set nome='"+nome+"' where id="+id+";";
	...
	public void excluirContatos(String id) {
